...
Shader "Sprites/Linear Gradient"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            {
                return sampleGradientColor (_GradientColors, _GradientPosition, _ColorCount, rotateUV(IN.texcoord, _Angle * DEGREE_2_RADIAN).y) * IN.color * IN.color.a;
            }
        ENDCG
        }
    }
